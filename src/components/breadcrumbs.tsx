...
const Breadcrumb: React.FC<BreadcrumbProps> = ({ title = "Boarding House", links = [], active = "", buttons }) => {
    return (
        <>
                    ...
                    <nav>
                        <ol className="flex items-center whitespace-nowrap min-w-0 pb-2 mt-4">
                            <li className="text-sm">
                                <Link className="flex items-center text-primary hover:text-primary dark:text-primary" to="/dashboard">
